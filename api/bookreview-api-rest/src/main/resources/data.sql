...
INSERT INTO book (author, cover, isbn, name, published)
	values ('Pierce Brown', 'https://m.media-amazon.com/images/I/61Xtkbld+6L.jpg', '978-8491879565', 'Amanecer rojo 2. Hijo dorado', '20220217');
INSERT INTO review (author, created, book_id, description)
	values ('Fernando Arévalo', '20230116', (select id from book where isbn = '978-8491879565'),
...
INSERT INTO book (author, cover, isbn, name, published)
	values ('J. R. R. Tolkien', 'https://m.media-amazon.com/images/I/91wA4QqjNDL.jpg', '978-8445012796', 'El Silmarillion', '19770915');
INSERT INTO review (author, created, book_id, description)
	values ('Fernando Arévalo', '20221221', (select id from book where isbn = '978-8445012796'),
...
INSERT INTO book (author, cover, isbn, name, published)
	values ('Ander Terrones Arellano', 'https://m.media-amazon.com/images/I/81sKLsews4L.jpg', '978-8435064057', 'La hija del loto', '20221012');
INSERT INTO review (author, created, book_id, description)
	values ('Raquel San Martín Rodriguez', '20221229', (select id from book where isbn = '978-8435064057'),
...
INSERT INTO book (author, cover, isbn, name, published)
	values ('Leslie G', 'https://m.media-amazon.com/images/I/91BCSJ+afSL.jpg', '978-8411312486', 'Erawol: La última leyenda', '20221115');
INSERT INTO review (author, created, book_id, description)
	values ('Ander Terrones Arellano', '20230102', (select id from book where isbn = '978-8411312486'),
...
INSERT INTO book (author, cover, isbn, name, published)
	values ('Filipe Melo / Juan Cavia', 'https://m.media-amazon.com/images/I/81QKQ6xHSSL.jpg', '978-8467948530', 'Balada para Sophie', '20221101');
INSERT INTO review (author, created, book_id, description)
	values ('Beatriz Mabbut', '20230113', (select id from book where isbn = '978-8467948530'),
